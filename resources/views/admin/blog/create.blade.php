    ...
    <div class="profile-content">
        <div class="profile-section active">
            <h3 class="section-title mb-4">
                <i class="bi bi-layout-text-sidebar"></i> افزودن بلاگ
            </h3>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="slug"
                                   value="{{old('slug')}}" placeholder="آدرس بلاگ در سایت" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="image_alt"
                                   value="{{old('image_alt')}}" maxlength="400">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="image_title"
                                   value="{{old('image_title')}}" maxlength="400">
                        </div>
                    </div>
